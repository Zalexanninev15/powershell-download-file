while (1 -lt 2) {
    $aggree_mc_eula = Read-Host -Prompt 'Please agree to Mojangs EULA, which is located here https://account.mojang.com/documents/minecraft_eula before continuing. [y/n]'
